...
# Unit tests for DesignHuddleAdmin::PageSceneSlidesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::PageSceneSlidesInner do
  let(:instance) { DesignHuddleAdmin::PageSceneSlidesInner.new }

  describe 'test an instance of PageSceneSlidesInner' do
    it 'should create an instance of PageSceneSlidesInner' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::PageSceneSlidesInner)
    end
  end
