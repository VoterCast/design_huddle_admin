...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTRequestOneOf2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTRequestOneOf2 do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTRequestOneOf2.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf2' do
    it 'should create an instance of ProjectsPOSTRequestOneOf2' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTRequestOneOf2)
    end
  end
