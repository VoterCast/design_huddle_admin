...
# Unit tests for DesignHuddleAdmin::BaseCreateSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::BaseCreateSuccess do
  let(:instance) { DesignHuddleAdmin::BaseCreateSuccess.new }

  describe 'test an instance of BaseCreateSuccess' do
    it 'should create an instance of BaseCreateSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::BaseCreateSuccess)
    end
  end
