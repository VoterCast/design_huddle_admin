...
# Unit tests for DesignHuddleAdmin::TemplateStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplateStatus do
  let(:instance) { DesignHuddleAdmin::TemplateStatus.new }

  describe 'test an instance of TemplateStatus' do
    it 'should create an instance of TemplateStatus' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplateStatus)
    end
  end
  describe 'test attribute "template_status_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "template_status_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
