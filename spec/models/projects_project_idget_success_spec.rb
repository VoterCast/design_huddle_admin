...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDGETSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDGETSuccess do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDGETSuccess.new }

  describe 'test an instance of ProjectsProjectIDGETSuccess' do
    it 'should create an instance of ProjectsProjectIDGETSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDGETSuccess)
    end
  end
