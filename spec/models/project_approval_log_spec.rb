...
# Unit tests for DesignHuddleAdmin::ProjectApprovalLog
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectApprovalLog do
  let(:instance) { DesignHuddleAdmin::ProjectApprovalLog.new }

  describe 'test an instance of ProjectApprovalLog' do
    it 'should create an instance of ProjectApprovalLog' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectApprovalLog)
    end
  end
