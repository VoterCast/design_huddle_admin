...
# Unit tests for DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOfData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOfData do
  let(:instance) { DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOfData.new }

  describe 'test an instance of TemplatesTemplateIDBaseSuccessOneOfData' do
    it 'should create an instance of TemplatesTemplateIDBaseSuccessOneOfData' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOfData)
    end
  end
