...
# Unit tests for DesignHuddleAdmin::Scene
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::Scene do
  let(:instance) { DesignHuddleAdmin::Scene.new }

  describe 'test an instance of Scene' do
    it 'should create an instance of Scene' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::Scene)
    end
  end
