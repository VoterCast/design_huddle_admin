...
# Unit tests for DesignHuddleAdmin::SceneSceneSlidesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::SceneSceneSlidesInner do
  let(:instance) { DesignHuddleAdmin::SceneSceneSlidesInner.new }

  describe 'test an instance of SceneSceneSlidesInner' do
    it 'should create an instance of SceneSceneSlidesInner' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::SceneSceneSlidesInner)
    end
  end
  ...
  describe 'test attribute "scene_slide_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
