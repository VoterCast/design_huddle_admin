...
# Unit tests for DesignHuddleAdmin::BaseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::BaseError do
  let(:instance) { DesignHuddleAdmin::BaseError.new }

  describe 'test an instance of BaseError' do
    it 'should create an instance of BaseError' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::BaseError)
    end
  end
