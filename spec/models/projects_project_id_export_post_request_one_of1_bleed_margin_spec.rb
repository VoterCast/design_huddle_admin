...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin.new }

  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf1BleedMargin)
    end
  end
