...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDPATCHRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDPATCHRequest do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDPATCHRequest.new }

  describe 'test an instance of ProjectsProjectIDPATCHRequest' do
    it 'should create an instance of ProjectsProjectIDPATCHRequest' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDPATCHRequest)
    end
  end
