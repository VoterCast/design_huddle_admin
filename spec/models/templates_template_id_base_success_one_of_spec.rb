...
# Unit tests for DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOf do
  let(:instance) { DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOf.new }

  describe 'test an instance of TemplatesTemplateIDBaseSuccessOneOf' do
    it 'should create an instance of TemplatesTemplateIDBaseSuccessOneOf' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesTemplateIDBaseSuccessOneOf)
    end
  end
