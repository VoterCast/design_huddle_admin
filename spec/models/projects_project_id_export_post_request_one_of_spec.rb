...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf.new }

  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf)
    end
  end
