...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportPOSTSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportPOSTSuccess do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportPOSTSuccess.new }

  describe 'test an instance of ProjectsProjectIDExportPOSTSuccess' do
    it 'should create an instance of ProjectsProjectIDExportPOSTSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportPOSTSuccess)
    end
  end
