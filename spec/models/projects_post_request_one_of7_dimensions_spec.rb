...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTRequestOneOf7Dimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTRequestOneOf7Dimensions do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTRequestOneOf7Dimensions.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf7Dimensions' do
    it 'should create an instance of ProjectsPOSTRequestOneOf7Dimensions' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTRequestOneOf7Dimensions)
    end
  end
