...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTRequestOneOf5
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTRequestOneOf5 do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTRequestOneOf5.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf5' do
    it 'should create an instance of ProjectsPOSTRequestOneOf5' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTRequestOneOf5)
    end
  end
  ...
  describe 'test attribute "size_to_background_image"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
