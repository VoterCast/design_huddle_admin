...
# Unit tests for DesignHuddleAdmin::MediaType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::MediaType do
  let(:instance) { DesignHuddleAdmin::MediaType.new }

  describe 'test an instance of MediaType' do
    it 'should create an instance of MediaType' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::MediaType)
    end
  end
  describe 'test attribute "media_type_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "media_type_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
