...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1 do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1.new }

  describe 'test an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1)
    end
  end
