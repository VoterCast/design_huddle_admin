...
# Unit tests for DesignHuddleAdmin::TemplateCustomizationObjectsPOSTRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplateCustomizationObjectsPOSTRequest do
  let(:instance) { DesignHuddleAdmin::TemplateCustomizationObjectsPOSTRequest.new }
  ...
  describe 'test an instance of TemplateCustomizationObjectsPOSTRequest' do
    it 'should create an instance of TemplateCustomizationObjectsPOSTRequest' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplateCustomizationObjectsPOSTRequest)
    end
  end
