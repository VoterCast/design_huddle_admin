...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTRequestOneOf7
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTRequestOneOf7 do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTRequestOneOf7.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf7' do
    it 'should create an instance of ProjectsPOSTRequestOneOf7' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTRequestOneOf7)
    end
  end
  ...
  describe 'test attribute "canvas_shape_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
