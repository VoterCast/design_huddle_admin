...
# Unit tests for DesignHuddleAdmin::UnitType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::UnitType do
  let(:instance) { DesignHuddleAdmin::UnitType.new }

  describe 'test an instance of UnitType' do
    it 'should create an instance of UnitType' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::UnitType)
    end
  end
  describe 'test attribute "unit_type_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "unit_type_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
