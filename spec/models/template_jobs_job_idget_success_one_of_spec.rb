...
# Unit tests for DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOf do
  let(:instance) { DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOf.new }

  describe 'test an instance of TemplateJobsJobIDGETSuccessOneOf' do
    it 'should create an instance of TemplateJobsJobIDGETSuccessOneOf' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOf)
    end
  end
