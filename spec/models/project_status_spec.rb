...
# Unit tests for DesignHuddleAdmin::ProjectStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectStatus do
  let(:instance) { DesignHuddleAdmin::ProjectStatus.new }

  describe 'test an instance of ProjectStatus' do
    it 'should create an instance of ProjectStatus' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectStatus)
    end
  end
  describe 'test attribute "project_status_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "project_status_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
