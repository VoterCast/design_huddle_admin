...
# Unit tests for DesignHuddleAdmin::UserGroup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::UserGroup do
  let(:instance) { DesignHuddleAdmin::UserGroup.new }

  describe 'test an instance of UserGroup' do
    it 'should create an instance of UserGroup' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::UserGroup)
    end
  end
  ...
  describe 'test attribute "user_group_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "user_group_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
