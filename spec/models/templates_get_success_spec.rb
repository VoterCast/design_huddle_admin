...
# Unit tests for DesignHuddleAdmin::TemplatesGETSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesGETSuccess do
  let(:instance) { DesignHuddleAdmin::TemplatesGETSuccess.new }

  describe 'test an instance of TemplatesGETSuccess' do
    it 'should create an instance of TemplatesGETSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesGETSuccess)
    end
  end
