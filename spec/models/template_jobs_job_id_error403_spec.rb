...
# Unit tests for DesignHuddleAdmin::TemplateJobsJobIDError403
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplateJobsJobIDError403 do
  let(:instance) { DesignHuddleAdmin::TemplateJobsJobIDError403.new }

  describe 'test an instance of TemplateJobsJobIDError403' do
    it 'should create an instance of TemplateJobsJobIDError403' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplateJobsJobIDError403)
    end
  end
