...
# Unit tests for DesignHuddleAdmin::UserGroupsMatchType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::UserGroupsMatchType do
  let(:instance) { DesignHuddleAdmin::UserGroupsMatchType.new }

  describe 'test an instance of UserGroupsMatchType' do
    it 'should create an instance of UserGroupsMatchType' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::UserGroupsMatchType)
    end
  end
  describe 'test attribute "user_groups_match_type_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "user_groups_match_type_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
