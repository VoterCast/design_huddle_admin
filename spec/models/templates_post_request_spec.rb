...
# Unit tests for DesignHuddleAdmin::TemplatesPOSTRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesPOSTRequest do
  let(:instance) { DesignHuddleAdmin::TemplatesPOSTRequest.new }

  describe 'test an instance of TemplatesPOSTRequest' do
    it 'should create an instance of TemplatesPOSTRequest' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesPOSTRequest)
    end
  end
