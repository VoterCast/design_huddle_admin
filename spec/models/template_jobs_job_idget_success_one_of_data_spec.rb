...
# Unit tests for DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOfData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOfData do
  let(:instance) { DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOfData.new }

  describe 'test an instance of TemplateJobsJobIDGETSuccessOneOfData' do
    it 'should create an instance of TemplateJobsJobIDGETSuccessOneOfData' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplateJobsJobIDGETSuccessOneOfData)
    end
  end
