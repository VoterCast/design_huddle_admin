...
# Unit tests for DesignHuddleAdmin::ProjectsGETSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsGETSuccess do
  let(:instance) { DesignHuddleAdmin::ProjectsGETSuccess.new }

  describe 'test an instance of ProjectsGETSuccess' do
    it 'should create an instance of ProjectsGETSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsGETSuccess)
    end
  end
