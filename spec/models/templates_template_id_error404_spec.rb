...
# Unit tests for DesignHuddleAdmin::TemplatesTemplateIDError404
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesTemplateIDError404 do
  let(:instance) { DesignHuddleAdmin::TemplatesTemplateIDError404.new }

  describe 'test an instance of TemplatesTemplateIDError404' do
    it 'should create an instance of TemplatesTemplateIDError404' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesTemplateIDError404)
    end
  end
