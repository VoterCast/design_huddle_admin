...
# Unit tests for DesignHuddleAdmin::BaseSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::BaseSuccess do
  let(:instance) { DesignHuddleAdmin::BaseSuccess.new }

  describe 'test an instance of BaseSuccess' do
    it 'should create an instance of BaseSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::BaseSuccess)
    end
  end
