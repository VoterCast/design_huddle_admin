...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTRequestOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTRequestOneOf do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTRequestOneOf.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf' do
    it 'should create an instance of ProjectsPOSTRequestOneOf' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTRequestOneOf)
    end
  end
