...
# Unit tests for DesignHuddleAdmin::ListSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ListSuccess do
  let(:instance) { DesignHuddleAdmin::ListSuccess.new }

  describe 'test an instance of ListSuccess' do
    it 'should create an instance of ListSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ListSuccess)
    end
  end
