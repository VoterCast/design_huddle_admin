...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTSuccess do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTSuccess.new }

  describe 'test an instance of ProjectsPOSTSuccess' do
    it 'should create an instance of ProjectsPOSTSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTSuccess)
    end
  end
