...
# Unit tests for DesignHuddleAdmin::ProjectApprovalStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectApprovalStatus do
  let(:instance) { DesignHuddleAdmin::ProjectApprovalStatus.new }

  describe 'test an instance of ProjectApprovalStatus' do
    it 'should create an instance of ProjectApprovalStatus' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectApprovalStatus)
    end
  end
  describe 'test attribute "project_approval_status_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "project_approval_status_name"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "project_approval_log"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
