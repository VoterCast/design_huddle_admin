...
# Unit tests for DesignHuddleAdmin::TemplatesTemplateIDGETSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesTemplateIDGETSuccess do
  let(:instance) { DesignHuddleAdmin::TemplatesTemplateIDGETSuccess.new }

  describe 'test an instance of TemplatesTemplateIDGETSuccess' do
    it 'should create an instance of TemplatesTemplateIDGETSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesTemplateIDGETSuccess)
    end
  end
