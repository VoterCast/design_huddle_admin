...
# Unit tests for DesignHuddleAdmin::Dimensions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::Dimensions do
  let(:instance) { DesignHuddleAdmin::Dimensions.new }

  describe 'test an instance of Dimensions' do
    it 'should create an instance of Dimensions' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::Dimensions)
    end
  end
