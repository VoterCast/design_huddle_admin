...
# Unit tests for DesignHuddleAdmin::ProjectsPOSTRequestOneOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsPOSTRequestOneOf1 do
  let(:instance) { DesignHuddleAdmin::ProjectsPOSTRequestOneOf1.new }

  describe 'test an instance of ProjectsPOSTRequestOneOf1' do
    it 'should create an instance of ProjectsPOSTRequestOneOf1' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsPOSTRequestOneOf1)
    end
  end
