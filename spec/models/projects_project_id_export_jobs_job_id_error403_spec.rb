...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDError403
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDError403 do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDError403.new }

  describe 'test an instance of ProjectsProjectIDExportJobsJobIDError403' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDError403' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDError403)
    end
  end
