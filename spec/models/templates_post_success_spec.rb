...
# Unit tests for DesignHuddleAdmin::TemplatesPOSTSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplatesPOSTSuccess do
  let(:instance) { DesignHuddleAdmin::TemplatesPOSTSuccess.new }

  describe 'test an instance of TemplatesPOSTSuccess' do
    it 'should create an instance of TemplatesPOSTSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplatesPOSTSuccess)
    end
  end
