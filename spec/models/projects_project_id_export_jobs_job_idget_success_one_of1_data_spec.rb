...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1Data
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1Data do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1Data.new }
  ...
  describe 'test an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1Data' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1Data' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf1Data)
    end
  end
