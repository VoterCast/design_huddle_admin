...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf.new }

  describe 'test an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOf' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOf)
    end
  end
