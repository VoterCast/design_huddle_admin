...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData.new }

  describe 'test an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData' do
    it 'should create an instance of ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportJobsJobIDGETSuccessOneOfData)
    end
  end
