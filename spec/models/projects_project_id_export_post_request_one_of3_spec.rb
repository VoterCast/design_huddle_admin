...
# Unit tests for DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf3 do
  let(:instance) { DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf3.new }

  describe 'test an instance of ProjectsProjectIDExportPOSTRequestOneOf3' do
    it 'should create an instance of ProjectsProjectIDExportPOSTRequestOneOf3' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf3)
    end
  end
