...
# Unit tests for DesignHuddleAdmin::TemplateCustomizationObjectsPOSTSuccess
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DesignHuddleAdmin::TemplateCustomizationObjectsPOSTSuccess do
  let(:instance) { DesignHuddleAdmin::TemplateCustomizationObjectsPOSTSuccess.new }

  describe 'test an instance of TemplateCustomizationObjectsPOSTSuccess' do
    it 'should create an instance of TemplateCustomizationObjectsPOSTSuccess' do
      expect(instance).to be_instance_of(DesignHuddleAdmin::TemplateCustomizationObjectsPOSTSuccess)
    end
  end
