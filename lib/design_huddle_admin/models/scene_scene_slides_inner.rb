...
module DesignHuddleAdmin
  class SceneSceneSlidesInner
    attr_accessor :scene_slide_id

    attr_accessor :scene_slide_number
    ...
    def self.attribute_map
      {
        ...
        :'scene_slide_number' => :'scene_slide_number',
        :'duration' => :'duration',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::SceneSceneSlidesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::SceneSceneSlidesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scene_slide_number')
        self.scene_slide_number = attributes[:'scene_slide_number']
      end
    ...
    def list_invalid_properties
      ...
      if @scene_slide_id.nil?
        invalid_properties.push('invalid value for "scene_slide_id", scene_slide_id cannot be nil.')
      end

      if @scene_slide_number.nil?
        invalid_properties.push('invalid value for "scene_slide_number", scene_slide_number cannot be nil.')
      end
    ...
    def valid?
      return false if @scene_slide_id.nil?
      return false if @scene_slide_number.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scene_slide_number == o.scene_slide_number &&
          duration == o.duration &&
    ...
    def hash
      [scene_slide_id, scene_slide_number, duration, thumbnail_url, date_created].hash
    end
