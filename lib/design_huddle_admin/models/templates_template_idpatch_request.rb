...
module DesignHuddleAdmin
  class TemplatesTemplateIDPATCHRequest
    ...
    attr_accessor :user_groups_match_type

    attr_accessor :user_group_ids

    attr_accessor :user_group_codes

    attr_accessor :replace_user_groups
    ...
    def self.attribute_map
      {
        ...
        :'user_groups_match_type' => :'user_groups_match_type',
        :'user_group_ids' => :'user_group_ids',
        :'user_group_codes' => :'user_group_codes',
        :'replace_user_groups' => :'replace_user_groups',
    ...
    def self.openapi_types
      {
        ...
        :'brand_id' => :'Float',
        :'brand_code' => :'String',
        :'user_groups_match_type' => :'String',
        :'user_group_ids' => :'Array<Integer>',
        :'user_group_codes' => :'Array<String>',
        :'replace_user_groups' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::TemplatesTemplateIDPATCHRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::TemplatesTemplateIDPATCHRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'user_groups_match_type')
        self.user_groups_match_type = attributes[:'user_groups_match_type']
      end
      ...
      if attributes.key?(:'user_group_codes')
        if (value = attributes[:'user_group_codes']).is_a?(Array)
          self.user_group_codes = value
        end
      end

      if attributes.key?(:'replace_user_groups')
        self.replace_user_groups = attributes[:'replace_user_groups']
      else
        self.replace_user_groups = false
      end
    ...
    def list_invalid_properties
      ...
      if !@template_code.nil? && @template_code.to_s.length > 50
        invalid_properties.push('invalid value for "template_code", the character length must be smaller than or equal to 50.')
      end

      if !@template_title.nil? && @template_title.to_s.length > 50
    ...
    def valid?
      return false if !@template_code.nil? && @template_code.to_s.length > 50
      return false if !@template_title.nil? && @template_title.to_s.length > 50
      ...
      user_groups_match_type_validator = EnumAttributeValidator.new('String', ["whitelist", "blacklist"])
      return false unless user_groups_match_type_validator.valid?(@user_groups_match_type)
      true
    end
    ...
    def template_code=(template_code)
      if !template_code.nil? && template_code.to_s.length > 50
        fail ArgumentError, 'invalid value for "template_code", the character length must be smaller than or equal to 50.'
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] user_groups_match_type Object to be assigned
    def user_groups_match_type=(user_groups_match_type)
      validator = EnumAttributeValidator.new('String', ["whitelist", "blacklist"])
      unless validator.valid?(user_groups_match_type)
        fail ArgumentError, "invalid value for \"user_groups_match_type\", must be one of #{validator.allowable_values}."
      end
      @user_groups_match_type = user_groups_match_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_groups_match_type == o.user_groups_match_type &&
          user_group_ids == o.user_group_ids &&
          user_group_codes == o.user_group_codes &&
          replace_user_groups == o.replace_user_groups &&
    ...
    def hash
      [template_code, template_title, template_status, brand_id, brand_code, user_groups_match_type, user_group_ids, user_group_codes, replace_user_groups, primary_template_category_item_id].hash
    end
