...
module DesignHuddleAdmin
  class ProjectsPOSTRequestOneOf1
    ...
    attr_accessor :customizations_hash
    ...
    def self.attribute_map
      {
        ...
        :'customizations_hash' => :'customizations_hash',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::ProjectsPOSTRequestOneOf1` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::ProjectsPOSTRequestOneOf1`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'customizations_hash')
        self.customizations_hash = attributes[:'customizations_hash']
      end
    ...
    def list_invalid_properties
      ...
      if @template_code.nil?
        invalid_properties.push('invalid value for "template_code", template_code cannot be nil.')
      end
    ...
    def valid?
      return false if @template_code.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          customizations_hash == o.customizations_hash &&
    ...
    def hash
      [project_title, template_code, customizations_hash, customizations].hash
    end
