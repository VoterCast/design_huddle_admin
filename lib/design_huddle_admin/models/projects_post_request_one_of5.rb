...
module DesignHuddleAdmin
  class ProjectsPOSTRequestOneOf5
    ...
    attr_accessor :size_to_background_image
    ...
    def self.attribute_map
      {
        ...
        :'size_to_background_image' => :'size_to_background_image',
        :'brand_id' => :'brand_id',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::ProjectsPOSTRequestOneOf5` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::ProjectsPOSTRequestOneOf5`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'project_title')
        self.project_title = attributes[:'project_title']
      end
      ...
      if attributes.key?(:'size_to_background_image')
        self.size_to_background_image = attributes[:'size_to_background_image']
      end
    ...
    def list_invalid_properties
      ...
      if @background_image_url.nil?
        invalid_properties.push('invalid value for "background_image_url", background_image_url cannot be nil.')
      end

      if @size_to_background_image.nil?
        invalid_properties.push('invalid value for "size_to_background_image", size_to_background_image cannot be nil.')
      end
    ...
    def valid?
      ...
      media_type_validator = EnumAttributeValidator.new('String', ["digital", "video", "print", "presentation"])
      return false unless media_type_validator.valid?(@media_type)
      return false if @background_image_url.nil?
      return false if @size_to_background_image.nil?
      true
    end
    ...
    def media_type=(media_type)
      validator = EnumAttributeValidator.new('String', ["digital", "video", "print", "presentation"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          size_to_background_image == o.size_to_background_image &&
          brand_id == o.brand_id &&
    ...
    def hash
      [project_title, media_type, background_image_url, size_to_background_image, brand_id, brand_code].hash
    end
