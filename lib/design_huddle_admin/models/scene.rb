...
module DesignHuddleAdmin
  class Scene
    ...
    attr_accessor :scene_number

    attr_accessor :scene_slides
    ...
    def self.openapi_types
      {
        ...
        :'scene_slides' => :'Array<SceneSceneSlidesInner>',
        :'duration' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::Scene` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::Scene`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scene_name')
        self.scene_name = attributes[:'scene_name']
      end

      if attributes.key?(:'scene_number')
        self.scene_number = attributes[:'scene_number']
      end

      if attributes.key?(:'scene_slides')
        if (value = attributes[:'scene_slides']).is_a?(Array)
          self.scene_slides = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @scene_id.nil?
        invalid_properties.push('invalid value for "scene_id", scene_id cannot be nil.')
      end

      if @scene_number.nil?
        invalid_properties.push('invalid value for "scene_number", scene_number cannot be nil.')
      end
    ...
    def valid?
      return false if @scene_id.nil?
      return false if @scene_number.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scene_number == o.scene_number &&
          scene_slides == o.scene_slides &&
          duration == o.duration &&
    ...
    def hash
      [scene_id, scene_name, scene_number, scene_slides, duration, thumbnail_url, date_created].hash
    end
