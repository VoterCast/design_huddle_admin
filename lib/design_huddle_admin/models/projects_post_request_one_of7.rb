...
module DesignHuddleAdmin
  class ProjectsPOSTRequestOneOf7
    attr_accessor :project_title

    attr_accessor :media_type

    attr_accessor :canvas_shape_url
    ...
    def self.attribute_map
      {
        ...
        :'canvas_shape_url' => :'canvas_shape_url',
    ...
    def self.openapi_types
      {
        ...
        :'dimensions' => :'ProjectsPOSTRequestOneOf7Dimensions',
        :'brand_id' => :'Integer',
        :'brand_code' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::ProjectsPOSTRequestOneOf7` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::ProjectsPOSTRequestOneOf7`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'canvas_shape_url')
        self.canvas_shape_url = attributes[:'canvas_shape_url']
      end
    ...
    def list_invalid_properties
      ...
      if @canvas_shape_url.nil?
        invalid_properties.push('invalid value for "canvas_shape_url", canvas_shape_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @canvas_shape_url.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          canvas_shape_url == o.canvas_shape_url &&
    ...
    def hash
      [project_title, media_type, canvas_shape_url, background_image_url, dimensions, brand_id, brand_code].hash
    end
