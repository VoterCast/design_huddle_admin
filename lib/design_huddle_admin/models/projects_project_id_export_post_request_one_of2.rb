...
module DesignHuddleAdmin
  class ProjectsProjectIDExportPOSTRequestOneOf2
    ...
    attr_accessor :scene_ids

    attr_accessor :scene_slide_id

    attr_accessor :scene_slide_ids
    ...
    def self.attribute_map
      {
        ...
        :'scene_slide_ids' => :'scene_slide_ids',
        :'fps' => :'fps',
        :'quality' => :'quality',
        :'no_audio' => :'no_audio',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf2` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DesignHuddleAdmin::ProjectsProjectIDExportPOSTRequestOneOf2`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scene_id')
        self.scene_id = attributes[:'scene_id']
      end

      if attributes.key?(:'scene_ids')
        if (value = attributes[:'scene_ids']).is_a?(Array)
          self.scene_ids = value
        end
      end

      if attributes.key?(:'scene_slide_id')
        self.scene_slide_id = attributes[:'scene_slide_id']
      end

      if attributes.key?(:'scene_slide_ids')
        if (value = attributes[:'scene_slide_ids']).is_a?(Array)
          self.scene_slide_ids = value
        end
      end
      ...
      if attributes.key?(:'no_audio')
        self.no_audio = attributes[:'no_audio']
      end
    ...
    def valid?
      ...
      quality_validator = EnumAttributeValidator.new('String', ["highest", "high", "normal", "low", "lowest"])
    ...
    def quality=(quality)
      validator = EnumAttributeValidator.new('String', ["highest", "high", "normal", "low", "lowest"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          scene_slide_id == o.scene_slide_id &&
          scene_slide_ids == o.scene_slide_ids &&
          fps == o.fps &&
          quality == o.quality &&
          no_audio == o.no_audio &&
    ...
    def hash
      [format, filename, scene_id, scene_ids, scene_slide_id, scene_slide_ids, fps, quality, no_audio, notification_url].hash
    end
