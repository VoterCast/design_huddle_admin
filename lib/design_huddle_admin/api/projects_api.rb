...
module DesignHuddleAdmin
  class ProjectsApi
    ...
    def projects_get_with_http_info(opts = {})
      ...
      allowable_values = ["project_id", "user", "media_type", "project_title", "project_status", "dimensions", "page_count", "scene_count", "duration", "thumbnail_url", "source_template", "brand", "project_approval_status", "date_created", "date_updated", "last_edited", "last_opened", "template_count", "presentation_count"]
